...
from utils import *
from loss import OriTripletLoss, TripletLoss_WRT, KLDivLoss, TripletLoss_ADP, FocalLoss
...
def main():                       
    ...
    if dataset == 'sysu':
        data_path = '../autodl-tmp/Datasets/SYSU-MM01/'
    ...
    suffix = suffix + '_p{}_n{}_lr_{}_seed_{}_focal1.2'.format( args.num_pos, args.batch_size, args.lr, args.seed)  
